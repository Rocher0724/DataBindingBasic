package choongyul.android.com.databinding.common.view;
...
import choongyul.android.com.databinding.R;
...
public class CircleImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(getWidth() / 2, getHeight() / 2, mBorderRadius-4.0f, mBorderPaint);
        canvas.drawCircle(getWidth() / 2 , getHeight() / 2, mDrawableRadius-4.0f, mBitmapPaint);
